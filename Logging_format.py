...
"""A decorator that will log all methods of the class being decorated (except for magic methods) and 
to which you can pass the output format of the date and time of logging."""
